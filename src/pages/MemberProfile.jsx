...
function MemberProfile() {
  ...
  const membersData = {
    1: { id: 1, name: 'Anupam Paul', studentId: '2204116', batch: '2022', department: 'CSE', initials: 'AP', type: 'Student', bio: 'Passionate about AI and Machine Learning. Looking for research opportunities.', skills: ['Python', 'Machine Learning', 'Data Science', 'React'], followers: 245, email: 'u2204116@student.cuet.ac.bd', address: 'Chittagong, Bangladesh', currentProfession: 'Student at CUET', researchInterests: ['Machine Learning', 'AI', 'Natural Language Processing'], education: [{ degree: 'B.Sc. in CSE', institution: 'CUET', year: '2022 - Present' }] },
